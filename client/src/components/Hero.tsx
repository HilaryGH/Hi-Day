const Hero = () => {
  return (
    <section id="home" className="relative bg-gradient-to-br from-orange-50 via-white to-orange-50 overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              Premium Hair & Wigs
              <span className="block text-[#F97316] mt-2">From China to Ethiopia</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <button className="bg-[#F97316] text-white px-8 py-4 rounded-lg hover:bg-[#EA580C] transition-all transform hover:scale-105 font-semibold text-lg shadow-lg">
                Browse Collection
              </button>
              <button className="bg-white text-[#F97316] border-2 border-[#F97316] px-8 py-4 rounded-lg hover:bg-orange-50 transition-all transform hover:scale-105 font-semibold text-lg">
                Learn More
              </button>
            </div>
            ...
            <div className="mt-12 grid grid-cols-3 gap-6">
              ...
              <div>
                <div className="text-3xl font-bold text-[#F97316]">5000+</div>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-6 -right-6 w-32 h-32 bg-orange-300 rounded-full opacity-50 blur-2xl"></div>
          </div>
        </div>
      </div>
