              ...
              <div className="hidden md:flex items-center gap-4">
                ...
                {user ? (
                  ...
                  <>
                    <Link 
                      to="/login" 
                      className="bg-[#16A34A] text-white px-4 py-2 rounded-lg hover:bg-[#15803D] transition-all shadow-sm hover:shadow-md text-sm font-medium"
                      title="Sign In"
                    >
                      Sign In
                    </Link>
        ...
        <div className="md:hidden bg-white border-b border-[#E5E7EB] shadow-lg">
          <div className="px-4 py-3 space-y-2">
            <Link 
              ...
              className="flex items-center gap-3 px-4 py-2 text-[#111827] hover:bg-[#F9FAFB] rounded-lg transition-colors"
            >
